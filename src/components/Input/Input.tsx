...
export const ContactInputs = () => {
    return (
        <div className="relative w-full px-9 py-3 font-medium group grid grid-cols-1 lg:grid-cols-2 gap-2">
            ...
            <input className={`col-span-1 lg:col-span-2 px-4 py-10 text-white bg-opacity-5 h-full bg-white border-2 border-primary-500`} placeholder='MESSAGE'/>
        </div>
    )
}
