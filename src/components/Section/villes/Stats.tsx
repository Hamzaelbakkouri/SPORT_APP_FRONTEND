...
import { CursorClick, MailOpen, Users } from 'heroicons-react'
const stats = [
    { id: 1, name: 'Total Subscribers', stat: '71,897', icon: Users, change: '122', changeType: 'increase' },
    { id: 2, name: 'Avg. Open Rate', stat: '58.16%', icon: MailOpen, change: '5.4%', changeType: 'increase' },
    { id: 3, name: 'Avg. Click Rate', stat: '24.57%', icon: CursorClick, change: '3.2%', changeType: 'decrease' },
]
