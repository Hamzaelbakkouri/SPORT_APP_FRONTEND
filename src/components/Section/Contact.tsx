...
const Contact = () => {
    return (
        <div className="grid lg:grid-cols-2 grid-col-1 text-center bg-black">
            <div
                className="col-span-1 lg:ml-44 mt-10 relative inline-block font-medium group"
            >
                <span className={`relative text-primary-500 group-hover:text-white`}><img className="w-full lg:w-[80%] object-cover" src="https://media1.popsugar-assets.com/files/thumbor/oxQ6oz09k5dj76iBWnQ8fQS-b0o/fit-in/728xorig/filters:format_auto-!!-:strip_icc-!!-/2017/11/10/736/n/1922729/59937a645a05d69045c832.75949516_edit_img_twitter_post_image_file_44242623_1510275897.jpg" alt="..." /></span>
            </div>
            <div className="col-span-1 gap-4 p-6">
                ...
                <div className="mt-20">
                    <ButtonBox field="Send Message" href="#" />
                </div>
            </div>
        </div>
    )
