...
export default function Third() {
    ...
    return (
        <div className="grid lg:grid-cols-2 grid-col-1 text-center mt-9">
            ...
            <div
                className="col-span-1 m-4 lg:ml-44 mt-10 relative inline-block font-medium group"
            >
                <span className={`absolute inset-0 w-full lg:w-[70%] h-full transition duration-200 ease-out transform translate-x-4 translate-y-4 bg-primary-500`}></span>
                <span className={`absolute inset-0 w-full lg:w-[70%] h-full bg-white border-2 border-primary-500`}></span>
                <span className={`relative text-primary-500 group-hover:text-white`}><img className="w-full lg:w-[70%] h-full" src="https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fGZsZXh8ZW58MHx8MHx8&w=1000&q=80" alt="..." /></span>
            </div>
        </div>
    )
}
