...
const Container = () => {
    return (
        <>
            <div className="bg-white py-16 lg:py-3 flex">
                <div className="relative max-w-full mx-auto px-4 sm:px-6 lg:px-10 flex flex-wrap" style={{
                    ...
                    <div className="md:w-[60%] relative py-24 px-8  rounded-md shadow-2xl overflow-hidden lg:px-16 lg:grid lg:grid-cols-3 lg:gap-x-8">
                            ...
                            <div className="mt-6 text-white ">
                                ...
                                <footer className="mt-6">
                                    <p className="flex flex-col font-medium">
                                        <span><ButtonBox field='Get Started Now' href='/' /></span>
                                    </p>
                                </footer>
                            </div>
                        </div>
                    ...
                    <div className='flex justify-center items-end'>
                        <div className='rounded-md bg-gray-950 h-72 flex p-11'>
